   ...
   return (
      <div style={{ backgroundColor: "#000", color: "#fff", minHeight: "100vh" }}>
         ...
         <div
            style={{
               background:
                  "linear-gradient(90deg, rgba(0,0,0,0.8) 0%, rgba(0,0,0,0.4) 100%), url('https://images.unsplash.com/photo-1489599735734-79b4d4c4b5a?w=1200')",
